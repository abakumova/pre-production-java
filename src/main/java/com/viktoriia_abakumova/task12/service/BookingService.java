package com.viktoriia_abakumova.task12.service;

import com.viktoriia_abakumova.task12.xml.Booking;
import com.viktoriia_abakumova.task12.dao.BookingDAO;
...
public class BookingService {
    ...
    public boolean isBookingExist(String doctorName, BigInteger timeSlot) {
        Optional<Booking> tvShowOptional = bookingDAO.get().stream().filter(x -> x.getDoctorName().equals(doctorName) && x.getTimeSlot().equals(timeSlot)).findAny();
