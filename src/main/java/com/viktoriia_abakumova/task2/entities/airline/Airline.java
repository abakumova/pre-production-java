package com.viktoriia_abakumova.task2.entities.airline;

import com.viktoriia_abakumova.task2.entities.aircrafts.Aircraft;
import com.viktoriia_abakumova.task2.comparators.AircraftCompare;
...
public class Airline {
    ...
    public void sortPlanesByFlightRange() {
        this.aircraft.sort(new AircraftCompare());
    }
